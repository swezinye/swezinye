...
### Analytics • Python • Power BI • Excel • SQL• R• Tableau • JMPPro

</div>

Welcome to my GitHub!  
I’m an analytics-focused MS Operations & Technology Management student with experience in business analysis, SAP, and data-driven decision making. I enjoy exploring datasets, building analytics pipelines, and turning data into actionable insights.

---

## 🔍 About Me
- 🎓 MS in Operations & Technology Management  
- 💼 2 years in operations and business analysis, plus 6+ years in supply chain, sales, and service operations   
- 🧠 Interested in supply chain analytics, predictive modeling, and process optimization  
- 💻 Strong skills in Excel, Power BI (DAX, Power Query), Python (Pandas), SQL & SAP (Super User)  
- 📍 Based in Portland, Oregon  
- 🌱 Currently sharpening my skills in cloud analytics & machine learning fundamentals
...
- R (probability, simulation & modeling)  
- SQL  
- Power BI (DAX, Data Modeling, Power Query)  
- Excel (dashboards, VLOOKUP/XLOOKUP, pivot tables, Power Query)  
- Tableau  
- SAP (Order-to-Cash, Pricing, Reporting)
...
## 📫 Connect With Me
- 🔗 LinkedIn: linkedin.com/in/swezinye  
